...
tbt.par <- par(mfrow=c(2, 1),
               ...
               mar=c(0,0,2,0))
#_______________________________________________________________________________
#substitute in location names to remove colon and replace with comma
new.hap.smplloc2 <- new.hap.smplloc
colnames(new.hap.smplloc2) <- gsub(":",", ",colnames(new.hap.smplloc))
#_______________________________________________________________________________
#make a haplotype network
pipNet <- pegas::haploNet(pipHaps)
#make a haplotype network
...
#add a legend to the plot
legend("bottomleft",colnames(new.hap.smplloc2), 
